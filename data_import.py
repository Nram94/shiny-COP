...
INPUTS = {
    ...
    "cl1_comp3_descriptor1": ui.input_radio_buttons(
        "cl1_comp3_descriptor1",
        competencias.descriptor1[2],
        choices=[1, 2, 3],
        selected=[],
        inline=True,
    ),
    "cl1_comp3_descriptor2": ui.input_radio_buttons(
        "cl1_comp3_descriptor2",
        competencias.descriptor2[2],
        choices=[1, 2, 3],
        selected=[],
        inline=True,
    ),
    "cl1_comp3_descriptor3": ui.input_radio_buttons(
        "cl1_comp3_descriptor3",
